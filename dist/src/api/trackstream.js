...
async function handler(nodelink, req, res, sendResponse, parsedUrl) {
    ...
    try {
        ...
        logger('error', 'TrackStream', `Failed to get track stream for ${encodedTrack}:`, err);
        sendErrorResponse(req, res, 500, 'Internal Server Error', err.message || 'Failed to get track stream', parsedUrl.pathname, true);
    }
}
export default {
    handler
